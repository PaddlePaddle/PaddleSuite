...
def main(image_files=None,save_dir = './output/new', is_eval=False, is_only_xycut=False):
...
if __name__ == "__main__":
    ...
    # save_dir = "/workspace/shuailiu35/compare_with_mineru/70/xycut"
    ...
    image_files = ["/workspace/shuailiu35/14-._.pdf"]
